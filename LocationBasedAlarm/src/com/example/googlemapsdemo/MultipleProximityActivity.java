...
public class MultipleProximityActivity extends FragmentActivity{
	GoogleMap googleMap;
        ...
        if(status!=ConnectionResult.SUCCESS){ // Google Play Services are not available
            ...
            googleMap.setOnMapClickListener(new OnMapClickListener() {
				...
				public void onMapClick(LatLng point) {				 
			        ...
			        // entered or exited
			        pendingIntent = PendingIntent.getActivity(getBaseContext(), count-1, proximityIntent,Intent.FLAG_ACTIVITY_NEW_TASK);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		menu.add(0, 0, 0, "Add Note");
		menu.add(0, 1, 1, "Show Notes");
		return true;
	}
